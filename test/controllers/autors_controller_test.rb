...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post autors_url, params: { autor: { autor_name: @autor.autor_name, autor_year: @autor.autor_year } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { autor_name: @autor.autor_name, autor_year: @autor.autor_year } }
